...
Learn how to install MCP Agent and set up your development environment.
...
<CardGroup cols={2}>
  <Card title="Fetch Server" icon="globe" href="https://github.com/modelcontextprotocol/servers/tree/main/src/fetch">
  ...
  <Card title="Filesystem Server" icon="folder" href="https://github.com/modelcontextprotocol/servers/tree/main/src/filesystem">
  ...
  <Card title="SQLite Server" icon="database" href="https://github.com/modelcontextprotocol/servers/tree/main/src/sqlite">
  ...
  <Card title="Git Server" icon="git-branch" href="https://github.com/modelcontextprotocol/servers/tree/main/src/git">
