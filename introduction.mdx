...
<Steps>
  ...
  <Step title="Workflow Patterns">
    Implement sophisticated agent behaviors
  </Step>
  <Step title="Model Providers">
...
<CardGroup cols={3}>
  <Card title="GitHub" icon="github" href="https://github.com/lastmile-ai/mcp-agent">
    Source code, issues, and contributions
  </Card>
  <Card title="Discord" icon="discord" href="https://lmai.link/discord/mcp-agent">
